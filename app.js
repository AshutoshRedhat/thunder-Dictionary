...
let apiKey = '24244be5-3024-407f-8663-8051dc81c383';
...
let infoContainer_color = "#dee1e7";

loading.style.display = 'none';
infoContainer.style.background = "none";

searchBtn.addEventListener('click', function(e){
    infoContainer.style.background = infoContainer_color;
    // myFooter.style.margin = "27vh";
    e.preventDefault();
